...
// $page_name="index.php?page=content/bidang/sekretariat.php";// If you use this code with a different page ( or file ) name then change this
if(isset($_GET['start']))
{
    $start = $_GET['start'];
...
$query2="SELECT * FROM berita WHERE bidang='Pembangunan Ekonomi'";
$result2=mysqli_query($connect ,$query2);
echo mysqli_error($connect);
$nume=mysqli_num_rows($result2);

$query="SELECT * FROM berita WHERE bidang='Pembangunan Ekonomi' order by tgl DESC limit $eu, $limit ";
