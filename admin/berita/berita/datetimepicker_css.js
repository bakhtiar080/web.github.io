...
var imageFilesPath = "../control-panel/promo/images2/";
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+imageFilesPath+"cal_close.png' width='20px' height='20px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
